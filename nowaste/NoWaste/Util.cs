  ...
  public class Util
  {
    ...
    public static void InitializeSetting()
    {
      ...
      if (CurrentSetting == null)
      {
        ...
        CurrentSetting.IsPriceVisible = false;
        CurrentSetting.IsDatePurchaseVisible = false;
    ...
    public static Item GetItemFromItemModel(ItemModel model)
    {
      ...
      item.PurchaseAmount = model.PurchaseAmount;
      return item;
    }
    ...
    public static ItemModel GetItemModelFromItem(Item item)
    {
      ...
      model.PurchaseAmount = item.PurchaseAmount;
      return model;
    }
  }
}
